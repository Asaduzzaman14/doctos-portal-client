...
const AddDoctors = () => {
    ...
    const { data: services, isLoading } = useQuery('services', (req, res) => fetch('https://fathomless-badlands-83387.herokuapp.com/service').then(res => res.json()).then())
        ...
        fetch(url, {
            ...
            .then(result => {
                if (result.success) {
                    ...
                    fetch('https://fathomless-badlands-83387.herokuapp.com/doctor', {
                        method: 'POST',
                        headers: {
